...
<body class="bg-gray-50 font-sans">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="text-center mb-8">
            <img src="{{ asset('images/logo-dge.png') }}" alt="Logo DGE" class="w-24 h-24 mx-auto mb-4">
        ...
        <div class="bg-white rounded-lg shadow-soft overflow-hidden">
            <div class="py-4 px-6 bg-primary-600 text-white">
                ...
                <p class="text-sm text-primary-100">Gestion du fichier électoral et contrôle des parrainages</p>
            </div>
            ...
            <div class="p-6">
                <div class="text-center mb-8">
                    ...
                    <a href="{{ route('agent_dge.login') }}" class="btn-primary inline-flex items-center justify-center">
        ...
        <div class="text-center mt-6">
            <a href="{{ url('/') }}" class="text-primary-600 hover:text-primary-800 flex items-center justify-center">
